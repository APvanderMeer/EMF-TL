...
public class EclipseTemplate implements IGenerator {
  ...
  protected void _compile(final Program p, final IFileSystemAccess filesystem) {
    ...
    final Function1<Type,Boolean> _function_2 = new Function1<Type,Boolean>() {
        public Boolean apply(final Type t) {
          ...
          boolean _contains = _name.contains("ConstraintVar");
  ...
  public Program setBase(final Program p) {
    Program _base = this.base = p;
    return _base;
  }
  
  public Integer getNextId() {
    int _plus = ((this.currentid).intValue() + 1);
    this.currentid = Integer.valueOf(_plus);
  ...
  public CharSequence toEclipseProgram(final Program p) {
    ...
    _builder.newLine();
    {
      ...
      final Function1<Constraint,Boolean> _function_5 = new Function1<Constraint,Boolean>() {
          public Boolean apply(final Constraint c) {
            String _name = c.getName();
            boolean _equals = Objects.equal(_name, "error");
            return Boolean.valueOf(_equals);
          }
        };
  ...
  public CharSequence makeConditionalError(final Integer n) {
    ...
    _builder.append(") :- getval(ts,Ts), ");
    {
      int _divide = ((n).intValue() / (this.objectSize).intValue());
      int _multiply = (_divide * (this.objectSize).intValue());
      int _plus = (_multiply + 1);
      boolean _notEquals = (_plus != (n).intValue());
      if (_notEquals) {
        _builder.append("once(arg(");
        int _divide_1 = ((n).intValue() / (this.objectSize).intValue());
        int _multiply_1 = (_divide_1 * (this.objectSize).intValue());
    ...
    _builder.append(_identifier2eclipse, "");
    {
      ...
      if (_exists) {
        ...
        if (!_equalsIgnoreCase) {
          ...
          boolean _greaterThan = (_size > 0);
          _and = (_equalsIgnoreCase && _greaterThan);
        }
        _or = (_exists || _and);
      }
      if (_or) {
  ...
  protected CharSequence _localconstraint2eclipse(final Integer index, final FoldConstraint c, final String operator) {
    ...
    _builder.append(" ");
    {
      ...
      for(final Constraint lc : _localconstraints) {
        ...
        CharSequence _localconstraint2eclipse = this.localconstraint2eclipse(index, lc, operator);
        _builder.append(_localconstraint2eclipse, " ");
      }
    }
    _builder.append(")");
  ...
  public CharSequence localequation2eclipse(final Integer index, final Equation e, final String operator) {
    CharSequence _xblockexpression = null;
    {
      ...
      Node _left = e.getLeft();
      String _plus = ("L" + i);
      CharSequence _newlocaleq2eclipse = this.newlocaleq2eclipse(index, _left, _plus);
      ...
      _builder.append(",");
      {
        ...
        if (_eIsSet) {
          Node _right = e.getRight();
          String _plus_1 = ("R" + i);
          CharSequence _newlocaleq2eclipse_1 = this.newlocaleq2eclipse(index, _right, _plus_1);
  ...
  protected CharSequence _newlocaleq2eclipse(final Integer index, final IndirectReference r, final String varname) {
    ...
    String _plus = (varname + "1");
    CharSequence _newlocaleq2eclipse = this.newlocaleq2eclipse(index, _expression, _plus);
    _builder.append(_newlocaleq2eclipse, "");
    _builder.append(",hastype(");
    String _plus_1 = (varname + "1");
    _builder.append(_plus_1, "");
    _builder.append(",");
              ...
              if (_equals_2) {
              ...
              } else {
                {
                  ...
                  if (_equals_3) {
                    ...
                    String _plus_4 = (varname + "1");
                    _builder.append(_plus_4, "");
                  } else {
                    _builder.append("genPairs(");
                    String _plus_5 = (varname + "1");
                    _builder.append(_plus_5, "");
                  }
                }
              }
  ...
  protected CharSequence _newlocaleq2eclipse(final Integer index, final BinaryNode e, final String varname) {
    StringConcatenation _builder = new StringConcatenation();
    Node _left = e.getLeft();
    String _plus = (varname + "l");
    CharSequence _newlocaleq2eclipse = this.newlocaleq2eclipse(index, _left, _plus);
    _builder.append(_newlocaleq2eclipse, "");
    _builder.append(",");
    Node _right = e.getRight();
    String _plus_1 = (varname + "r");
    CharSequence _newlocaleq2eclipse_1 = this.newlocaleq2eclipse(index, _right, _plus_1);
    _builder.append(_newlocaleq2eclipse_1, "");
    _builder.append(",");
    ...
    _builder.append(_operator2eclipse, "");
    _builder.append("(");
    String _plus_2 = (varname + "l");
    _builder.append(_plus_2, "");
    _builder.append(",");
    String _plus_3 = (varname + "r");
    _builder.append(_plus_3, "");
    _builder.append(",");
    _builder.append(varname, "");
    _builder.append(")");
    ...
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_greaterThan) {
        ...
        if (!_equalsIgnoreCase) {
          ...
          _and = (_equalsIgnoreCase && _greaterThan_1);
        }
        _or = (_greaterThan || _and);
      }
      if (_or) {
        _builder.append("V");
        int _number = myvar.getNumber();
  ...
  public String operator2eclipse(final BinOp o) {
    ...
    if (!_matched) {
      if (Objects.equal(o,BinOp.ADDITION)) {
        _matched=true;
        _switchResult = "+";
      }
    }
    if (!_matched) {
      if (Objects.equal(o,BinOp.SUBTRACTION)) {
        _matched=true;
        _switchResult = "-";
      }
    }
    if (!_matched) {
      if (Objects.equal(o,BinOp.PROJECTION)) {
        _matched=true;
        _switchResult = ".";
      }
    }
    if (!_matched) {
      if (Objects.equal(o,BinOp.CONCATENATION)) {
        _matched=true;
        _switchResult = "union";
      }
    }
  ...
  public boolean hasRightVarRef(final Equation e) {
    Node _right = e.getRight();
    boolean _isVariableReference = this.isVariableReference(_right);
    return _isVariableReference;
  }
        ...
        public Boolean apply(final Variable v) {
          ...
          final Function1<Variable,Boolean> _function = new Function1<Variable,Boolean>() {
              public Boolean apply(final Variable lv) {
                ...
                int _number_1 = v.getNumber();
                boolean _equals = (_number == _number_1);
                return Boolean.valueOf(_equals);
              }
            };
          ...
          if (!_not) {
            ...
            final Function1<Generator,Boolean> _function_1 = new Function1<Generator,Boolean>() {
                public Boolean apply(final Generator g) {
                  ...
                  boolean _exists = IterableExtensions.<Variable>exists(_variables, _function);
  ...
  protected HashSet<Variable> _getVariableSet(final EquationConstraint c) {
    HashSet<Variable> _hashSet = new HashSet<Variable>();
    Set<Variable> varset = _hashSet;
    EList<Equation> _equation = c.getEquation();
  ...
  protected HashSet<Variable> _getVariableSet(final FoldConstraint c) {
    HashSet<Variable> _hashSet = new HashSet<Variable>();
    Set<Variable> varset = _hashSet;
    EList<Generator> _containers = c.getContainers();
  ...
  public List<Integer> makeNumberList(final Integer n) {
    ArrayList<Integer> _arrayList = new ArrayList<Integer>((n).intValue());
    List<Integer> list = _arrayList;
    int i = 0;
    boolean _lessEqualsThan = (i <= (n).intValue());
    ...
    while (_while) {
      ...
      boolean _lessEqualsThan_1 = (i <= (n).intValue());
  ...
  public HashSet<Variable> getVariableSet(final Constraint c) {
    if (c instanceof EquationConstraint) {
