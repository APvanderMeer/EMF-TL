 ...
 * 
 */
package org.emftext.language.textAML3.resource.textAML3.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class TextAML3LaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.emftext.language.textAML3.resource.textAML3.util.AbstractTextAML3Interpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.emftext.language.textAML3.resource.textAML3.util.AbstractTextAML3Interpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebuggableInterpreter<ResultType, ContextType> interpreter = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebuggerListener<ResultType, ContextType> debugListener = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProcess process = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProcess(launch);
		launch.addDebugTarget(new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.emftext.language.textAML3.resource.textAML3.launch.TextAML3LaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.emftext.language.textAML3.resource.textAML3.util.TextAML3ResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
