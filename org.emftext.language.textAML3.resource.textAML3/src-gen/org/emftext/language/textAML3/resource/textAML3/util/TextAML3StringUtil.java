 ...
 */
public class TextAML3StringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.emftext.language.textAML3.resource.textAML3.ITextAML3Function1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.emftext.language.textAML3.resource.textAML3.ITextAML3Function1<String, T> toStringFunction) {
