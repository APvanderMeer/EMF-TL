 ...
 * contains
 * <code>org.emftext.language.textAML3.resource.textAML3.ITextAML3TextDiagnostic</c
 * ode>s it uses the more precise information of this extended diagnostic type.
 */
public class TextAML3MarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object>> commands = new java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.textAML3.resource.textAML3.ITextAML3TextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.textAML3.resource.textAML3.ITextAML3TextDiagnostic diagnostic) {
		final org.emftext.language.textAML3.resource.textAML3.ITextAML3Problem problem = diagnostic.getProblem();
		org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemSeverity.ERROR) {
					...
					org.emftext.language.textAML3.resource.textAML3.ITextAML3TextDiagnostic textDiagnostic = (org.emftext.language.textAML3.resource.textAML3.ITextAML3TextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.textAML3.resource.textAML3.ITextAML3QuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.textAML3.resource.textAML3.util.TextAML3StringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType nextType : org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.language.textAML3.resource.textAML3.util.TextAML3RuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
