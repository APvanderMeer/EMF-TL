...
public class TextAML3LineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.emftext.language.textAML3.resource.textAML3.debug.lineBreakpoint.marker";
	
	public TextAML3LineBreakpoint() {
		super();
	}
	
	public TextAML3LineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugTarget target) {
		try {
	...
	public void remove(org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
