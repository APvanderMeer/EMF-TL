...
public class TextAML3DebugTarget extends org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.emftext.language.textAML3.resource.textAML3.debug.ITextAML3DebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProcess process;
	...
	private org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.emftext.language.textAML3.resource.textAML3.debug.ITextAML3DebugEventListener> eventListeners = new java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.debug.ITextAML3DebugEventListener>();
	
	private org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.emftext.language.textAML3.resource.textAML3.debug.ITextAML3DebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public TextAML3DebugTarget(org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.emftext.language.textAML3.resource.textAML3.debug.ITextAML3DebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.emftext.language.textAML3.resource.textAML3.debug.ITextAML3DebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.emftext.language.textAML3.resource.textAML3.debug.TextAML3LineBreakpoint lineBreakpoint = (org.emftext.language.textAML3.resource.textAML3.debug.TextAML3LineBreakpoint) breakpoint;
	...
	public org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugProxy getDebugProxy() {
