 ...
 */
public class TextAML3Plugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.textAML3.resource.textAML3";
	/**
	...
	private static TextAML3Plugin plugin;
	
	public TextAML3Plugin() {
		super();
	}
	...
	public static TextAML3Plugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, TextAML3Plugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, TextAML3Plugin.PLUGIN_ID, message);
		}
		final TextAML3Plugin pluginInstance = TextAML3Plugin.getDefault();
