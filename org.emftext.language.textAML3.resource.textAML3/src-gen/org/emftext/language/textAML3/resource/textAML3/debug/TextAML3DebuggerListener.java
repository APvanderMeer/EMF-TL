 ...
 * code).
 */
public class TextAML3DebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.emftext.language.textAML3.resource.textAML3.debug.AbstractTextAML3Debuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.emftext.language.textAML3.resource.textAML3.util.TextAML3Pair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.emftext.language.textAML3.resource.textAML3.util.TextAML3Pair<String, Object>>();
	...
	public TextAML3DebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.emftext.language.textAML3.resource.textAML3.util.TextAML3StringUtil.encode('#', stack);
				org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage message = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage message = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.GET_VARIABLES)) {
				...
				org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage message = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugMessage(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.emftext.language.textAML3.resource.textAML3.util.TextAML3StringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.emftext.language.textAML3.resource.textAML3.util.TextAML3Pair<String, Object> pair = new org.emftext.language.textAML3.resource.textAML3.util.TextAML3Pair<String, Object>(name, value);
	...
	public org.emftext.language.textAML3.resource.textAML3.debug.AbstractTextAML3Debuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.emftext.language.textAML3.resource.textAML3.debug.AbstractTextAML3Debuggable debuggable) {
