...
public class TextAML3BuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.emftext.language.textAML3.resource.textAML3.builder";
	
	private org.emftext.language.textAML3.resource.textAML3.ITextAML3Builder defaultBuilder = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Builder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.emftext.language.textAML3.resource.textAML3.ITextAML3Builder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource customResource = (org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource) resourceSet.getResource(uri, true);
			new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.emftext.language.textAML3.resource.textAML3.ITextAML3Builder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MarkerHelper().getMarkerID(org.emftext.language.textAML3.resource.textAML3.TextAML3EProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3TaskItemBuilder taskItemBuilder = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3TaskItemBuilder();
		new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getSyntaxName())) {
