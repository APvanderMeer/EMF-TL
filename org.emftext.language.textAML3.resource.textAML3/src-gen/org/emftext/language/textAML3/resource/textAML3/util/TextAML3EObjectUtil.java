 ...
 */
public class TextAML3EObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			new org.emftext.language.textAML3.resource.textAML3.util.TextAML3RuntimeUtil().logError("Exception while matching proxy URI.", e);
