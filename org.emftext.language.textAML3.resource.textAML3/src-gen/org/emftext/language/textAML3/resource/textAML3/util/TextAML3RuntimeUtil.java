 ...
 */
public class TextAML3RuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
