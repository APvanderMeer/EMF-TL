...
public class TextAML3StackFrame extends org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugTarget target;
	private String name;
	private int id;
	...
	public TextAML3StackFrame(org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.emftext.language.textAML3.resource.textAML3.util.TextAML3StringUtil.decode(data, ',');
	...
	private org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.emftext.language.textAML3.resource.textAML3.debug.TextAML3StackFrame other = (org.emftext.language.textAML3.resource.textAML3.debug.TextAML3StackFrame) obj;
		if (name == null) {
