 ...
 */
public class TextAML3DefaultTokenResolver implements org.emftext.language.textAML3.resource.textAML3.ITextAML3TokenResolver {
	 ...
	 */
	public TextAML3DefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public TextAML3DefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.textAML3.resource.textAML3.ITextAML3TokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3GrammarInformationProvider.INSTANCE.getKeywords()) {
