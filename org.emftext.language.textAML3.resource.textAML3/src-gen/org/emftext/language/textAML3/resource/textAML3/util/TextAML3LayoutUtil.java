 ...
 */
public class TextAML3LayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3SyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3GrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3SyntaxElement syntaxElement = org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3GrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3Placeholder) {
			org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3Placeholder placeholder = (org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3Placeholder) syntaxElement;
			org.emftext.language.textAML3.resource.textAML3.ITextAML3TokenResolver tokenResolver = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3TokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.emftext.language.textAML3.resource.textAML3.ITextAML3TokenResolveResult result = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3TokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3LayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
