 ...
 */
public class TextAML3LaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new org.emftext.language.textAML3.resource.textAML3.launch.TextAML3LaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
