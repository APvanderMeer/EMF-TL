 ...
 */
public class TextAML3DebuggableInterpreter<ResultType, ContextType> extends org.emftext.language.textAML3.resource.textAML3.debug.AbstractTextAML3Debuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private org.emftext.language.textAML3.resource.textAML3.util.AbstractTextAML3Interpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public TextAML3DebuggableInterpreter(org.emftext.language.textAML3.resource.textAML3.util.AbstractTextAML3Interpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new org.emftext.language.textAML3.resource.textAML3.ITextAML3InterpreterListener() {
	...
	public String[] getStack() {
		...
		for (org.eclipse.emf.ecore.EObject parent : parents) {
			String serializedStackElement = org.emftext.language.textAML3.resource.textAML3.util.TextAML3StringUtil.encode(',', new String[] {parent.eClass().getName(), Integer.toString(stackFrameID), parent.eResource().getURI().toString(), Integer.toString(getLine(parent)), Integer.toString(getCharStart(parent)), Integer.toString(getCharEnd(parent))});
	...
	public org.emftext.language.textAML3.resource.textAML3.util.AbstractTextAML3Interpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		org.emftext.language.textAML3.resource.textAML3.ITextAML3LocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private org.emftext.language.textAML3.resource.textAML3.ITextAML3LocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(org.emftext.language.textAML3.resource.textAML3.debug.ETextAML3DebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = org.emftext.language.textAML3.resource.textAML3.util.TextAML3EObjectUtil.getDepth(current);
		stopCondition = new org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = org.emftext.language.textAML3.resource.textAML3.util.TextAML3EObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = org.emftext.language.textAML3.resource.textAML3.util.TextAML3EObjectUtil.getDepth(current) - 1;
		stopCondition = new org.emftext.language.textAML3.resource.textAML3.ITextAML3Command<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
