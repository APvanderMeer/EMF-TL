...
public class TextAML3ResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public TextAML3ResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.emftext.language.textAML3.resource.textAML3.util.TextAML3RuntimeUtil().isEclipsePlatformAvailable()) {
			new org.emftext.language.textAML3.resource.textAML3.util.TextAML3EclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3ResourceFactory());
		}
	}
