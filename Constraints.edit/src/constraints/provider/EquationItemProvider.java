...
/**
 * This is the item provider adapter for a {@link constraints.Equation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EquationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Equation_left_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Equation_left_feature", "_UI_Equation_type"),
				 ConstraintsPackage.Literals.EQUATION__LEFT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Equation_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Equation_operation_feature", "_UI_Equation_type"),
				 ConstraintsPackage.Literals.EQUATION__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstraintsPackage.Literals.EQUATION__RIGHT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Equation_type") + " " + equation.getLine();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Equation.class)) {
			case ConstraintsPackage.EQUATION__OPERATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.EQUATION__RIGHT,
