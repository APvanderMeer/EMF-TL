...
/**
 * This is the item provider adapter for a {@link constraints.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_number_feature", "_UI_Variable_type"),
				 ConstraintsPackage.Literals.VARIABLE__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstraintsPackage.Literals.VARIABLE__REFERENCES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstraintsPackage.Literals.VARIABLE__TYPE);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Variable_type") + " " + variable.getNumber();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.VARIABLE__TYPE,
