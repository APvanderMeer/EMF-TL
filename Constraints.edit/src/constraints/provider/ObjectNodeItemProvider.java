...
/**
 * This is the item provider adapter for a {@link constraints.ObjectNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectNodeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstraintsPackage.Literals.OBJECT_NODE__FEATURES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ObjectNode"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ObjectNode.class)) {
			case ConstraintsPackage.OBJECT_NODE__FEATURES:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), true, false));
				return;
			case ConstraintsPackage.OBJECT_NODE__NAME:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.OBJECT_NODE__FEATURES,
				 ConstraintsFactory.eINSTANCE.createFeature()));
	}
