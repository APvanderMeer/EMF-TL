...
/**
 * This is the item provider adapter for a {@link constraints.Position} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PositionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Position_line_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Position_line_feature", "_UI_Position_type"),
				 ConstraintsPackage.Literals.POSITION__LINE,
				 true,
				 false,
				 false,
	...
	protected void addColumnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Position_column_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Position_column_feature", "_UI_Position_type"),
				 ConstraintsPackage.Literals.POSITION__COLUMN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Position_type") + " " + position.getLine();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Position.class)) {
			case ConstraintsPackage.POSITION__LINE:
			case ConstraintsPackage.POSITION__COLUMN:
