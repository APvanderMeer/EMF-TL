...
/**
 * This is the item provider adapter for a {@link constraints.Literal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstraintsPackage.Literals.LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Literal.class)) {
			case ConstraintsPackage.LITERAL__VALUE:
				...
				return;
			case ConstraintsPackage.LITERAL__NAME:
