...
/**
 * This is the item provider adapter for a {@link constraints.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstraintsPackage.Literals.TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_parameters_feature", "_UI_Type_type"),
				 ConstraintsPackage.Literals.TYPE__PARAMETERS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Type.class)) {
			case ConstraintsPackage.TYPE__NAME:
			case ConstraintsPackage.TYPE__PARAMETERS:
