...
/**
 * This is the item provider adapter for a {@link constraints.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstraintsPackage.Literals.CONSTRAINT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstraintsPackage.Literals.CONSTRAINT__LOCALCONSTRAINTS);
			childrenFeatures.add(ConstraintsPackage.Literals.CONSTRAINT__LOCALVARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.CONSTRAINT__LOCALCONSTRAINTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.CONSTRAINT__LOCALVARIABLES,
