...
/**
 * This is the item provider adapter for a {@link constraints.VariableReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableReferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableReference_var_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableReference_var_feature", "_UI_VariableReference_type"),
				 ConstraintsPackage.Literals.VARIABLE_REFERENCE__VAR,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariableReference.class)) {
			case ConstraintsPackage.VARIABLE_REFERENCE__NAME:
