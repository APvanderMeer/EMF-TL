...
/**
 * This is the item provider adapter for a {@link textualmcrl2.Allow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AllowItemProvider
	 ...
	 * @generated
	 */
	public AllowItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Allow_atomnames_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Allow_atomnames_feature", "_UI_Allow_type"),
				 Textualmcrl2Package.Literals.ALLOW__ATOMNAMES,
				 true,
				 false,
				 false,
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Allow_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Allow_links_feature", "_UI_Allow_type"),
				 Textualmcrl2Package.Literals.ALLOW__LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.ALLOW__CHILD);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Allow"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Allow_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Allow.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.ALLOW__CHILD,
