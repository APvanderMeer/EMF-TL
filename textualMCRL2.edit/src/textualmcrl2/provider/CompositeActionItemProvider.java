...
/**
 * This is the item provider adapter for a {@link textualmcrl2.CompositeAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeActionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.COMPOSITE_ACTION__LEFT);
		}
	...
	public String getText(Object object) {
		return getString("_UI_CompositeAction_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeAction.class)) {
			case Textualmcrl2Package.COMPOSITE_ACTION__LEFT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.COMPOSITE_ACTION__LEFT,
