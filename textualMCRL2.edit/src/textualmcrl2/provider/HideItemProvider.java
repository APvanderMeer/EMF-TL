...
/**
 * This is the item provider adapter for a {@link textualmcrl2.Hide} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HideItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hide_atomnames_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hide_atomnames_feature", "_UI_Hide_type"),
				 Textualmcrl2Package.Literals.HIDE__ATOMNAMES,
				 true,
				 false,
				 false,
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hide_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hide_links_feature", "_UI_Hide_type"),
				 Textualmcrl2Package.Literals.HIDE__LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.HIDE__CHILD);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Hide.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.HIDE__CHILD,
