...
/**
 * This is the item provider adapter for a {@link textualmcrl2.ProcessDecl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessDeclItemProvider
	 ...
	 * @generated
	 */
	public ProcessDeclItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.PROCESS_DECL__ACTION);
			childrenFeatures.add(Textualmcrl2Package.Literals.PROCESS_DECL__PROCESS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessDecl"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_ProcessDecl_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProcessDecl.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.PROCESS_DECL__ACTION,
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.PROCESS_DECL__PROCESS,
				 Textualmcrl2Factory.eINSTANCE.createProcess()));
	}
