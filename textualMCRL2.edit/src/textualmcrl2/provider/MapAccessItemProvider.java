...
/**
 * This is the item provider adapter for a {@link textualmcrl2.MapAccess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapAccessItemProvider
	 ...
	 * @generated
	 */
	public MapAccessItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.MAP_ACCESS__BASE);
			childrenFeatures.add(Textualmcrl2Package.Literals.MAP_ACCESS__KEY);
			childrenFeatures.add(Textualmcrl2Package.Literals.MAP_ACCESS__VALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MapAccess"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_MapAccess_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MapAccess.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.MAP_ACCESS__BASE,
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.MAP_ACCESS__KEY,
				 Textualmcrl2Factory.eINSTANCE.createIdentifier()));
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.MAP_ACCESS__VALUE,
				 Textualmcrl2Factory.eINSTANCE.createIdentifier()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Textualmcrl2Package.Literals.MAP_ACCESS__BASE ||
			childFeature == Textualmcrl2Package.Literals.MAP_ACCESS__KEY ||
			childFeature == Textualmcrl2Package.Literals.MAP_ACCESS__VALUE;
