...
/**
 * This is the item provider adapter for a {@link textualmcrl2.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.PROCESS__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((textualmcrl2.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(textualmcrl2.Process.class)) {
			case Textualmcrl2Package.PROCESS__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.PROCESS__PARAMETERS,
