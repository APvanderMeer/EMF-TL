...
/**
 * This is the item provider adapter for a {@link textualmcrl2.Constructor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstructorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constructor_discriminator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constructor_discriminator_feature", "_UI_Constructor_type"),
				 Textualmcrl2Package.Literals.CONSTRUCTOR__DISCRIMINATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.CONSTRUCTOR__PROJECTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constructor.class)) {
			case Textualmcrl2Package.CONSTRUCTOR__DISCRIMINATOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Textualmcrl2Package.CONSTRUCTOR__PROJECTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.CONSTRUCTOR__PROJECTIONS,
				 Textualmcrl2Factory.eINSTANCE.createProjection()));
	}
