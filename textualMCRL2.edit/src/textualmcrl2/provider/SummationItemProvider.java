...
/**
 * This is the item provider adapter for a {@link textualmcrl2.Summation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SummationItemProvider
	 ...
	 * @generated
	 */
	public SummationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.SUMMATION__PARAMETERS);
			childrenFeatures.add(Textualmcrl2Package.Literals.SUMMATION__CHILD);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Summation"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Summation_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Summation.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.SUMMATION__PARAMETERS,
				 Textualmcrl2Factory.eINSTANCE.createIdDecl()));

		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.SUMMATION__CHILD,
