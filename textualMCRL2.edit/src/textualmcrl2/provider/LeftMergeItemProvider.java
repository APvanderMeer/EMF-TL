...
/**
 * This is the item provider adapter for a {@link textualmcrl2.LeftMerge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LeftMergeItemProvider
	 ...
	 * @generated
	 */
	public LeftMergeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.LEFT_MERGE__RIGHT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LeftMerge"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_LeftMerge_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LeftMerge.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.LEFT_MERGE__RIGHT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == Textualmcrl2Package.Literals.LEFT_MERGE__RIGHT;
