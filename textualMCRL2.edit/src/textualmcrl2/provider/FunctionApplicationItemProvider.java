...
/**
 * This is the item provider adapter for a {@link textualmcrl2.FunctionApplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionApplicationItemProvider
	 ...
	 * @generated
	 */
	public FunctionApplicationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionApplication_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionApplication_links_feature", "_UI_FunctionApplication_type"),
				 Textualmcrl2Package.Literals.FUNCTION_APPLICATION__LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.FUNCTION_APPLICATION__BASE);
			childrenFeatures.add(Textualmcrl2Package.Literals.FUNCTION_APPLICATION__ARGUMENTS);
		}
	...
	/**
	 * This returns FunctionApplication.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FunctionApplication"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_FunctionApplication_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionApplication.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.FUNCTION_APPLICATION__BASE,
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.FUNCTION_APPLICATION__ARGUMENTS,
				 Textualmcrl2Factory.eINSTANCE.createIdentifier()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Textualmcrl2Package.Literals.FUNCTION_APPLICATION__BASE ||
			childFeature == Textualmcrl2Package.Literals.FUNCTION_APPLICATION__ARGUMENTS;
