...
/**
 * This is the item provider adapter for a {@link textualmcrl2.Synchronization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SynchronizationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Textualmcrl2Package.Literals.SYNCHRONIZATION__RIGHT);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Synchronization_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Synchronization.class)) {
			case Textualmcrl2Package.SYNCHRONIZATION__RIGHT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Textualmcrl2Package.Literals.SYNCHRONIZATION__RIGHT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == Textualmcrl2Package.Literals.SYNCHRONIZATION__RIGHT;
