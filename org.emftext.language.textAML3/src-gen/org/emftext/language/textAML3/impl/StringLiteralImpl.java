 ...
 * <ul>
 *   <li>{@link org.emftext.language.textAML3.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return TextAML3Package.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextAML3Package.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TextAML3Package.STRING_LITERAL__VALUE:
				return getValue();
		}
