 ...
 * <!-- end-user-doc -->
 * @see constraints.ConstraintsPackage#getBinOp()
 * @model
 * @generated
 */
public enum BinOp implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BinOp[] VALUES_ARRAY =
		new BinOp[] {
			ADDITION,
			SUBTRACTION,
			MULTIPLICATION,
	 ...
	 * @generated
	 */
	public static final List<BinOp> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
