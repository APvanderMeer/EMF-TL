 ...
 */
public class TextAML3BackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource resource, final org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource resource, final org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource resource, final org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource) {
							org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource concreteResource = (org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource) resource;
