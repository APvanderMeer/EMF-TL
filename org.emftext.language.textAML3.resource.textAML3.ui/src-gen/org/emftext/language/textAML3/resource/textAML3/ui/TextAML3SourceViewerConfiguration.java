 ...
 */
public class TextAML3SourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3QuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public TextAML3SourceViewerConfiguration(org.emftext.language.textAML3.resource.textAML3.ITextAML3ResourceProvider resourceProvider, org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3AnnotationModelProvider annotationModelProvider, org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3BracketHandlerProvider bracketHandlerProvider, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3ColorManager colorManager) {
		super(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3CompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3QuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3IgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
