 ...
 * a specified depth.
 */
public class TextAML3OutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public TextAML3OutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.textAML3.resource.textAML3.util.TextAML3StringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.textAML3.resource.textAML3.ui.TextAML3EObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.logError("Exception while refreshing outline view", e);
		}
	}
