 ...
 */
public class TextAML3SyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public TextAML3SyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PixelConverter pixelConverter = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor) {
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor emfTextEditor = (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor) editor;
