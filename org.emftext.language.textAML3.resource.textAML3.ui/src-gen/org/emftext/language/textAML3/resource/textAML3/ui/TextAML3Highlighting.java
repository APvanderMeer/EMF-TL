 ...
 */
public class TextAML3Highlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionHelper positionHelper = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionHelper();
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TokenScanner scanner;
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Occurrence occurrence;
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.textAML3.resource.textAML3.ITextAML3BackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public TextAML3Highlighting(org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3ColorManager colorManager, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Occurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3EObjectSelection(selectedEObject, false));
				}
			}
		});
	}
