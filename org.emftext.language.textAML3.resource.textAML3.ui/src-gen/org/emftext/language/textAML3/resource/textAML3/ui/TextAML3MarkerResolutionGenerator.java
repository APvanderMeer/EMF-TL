...
public class TextAML3MarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.emftext.language.textAML3.resource.textAML3.ITextAML3Options.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource) {
					org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource customResource = (org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Resource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.emftext.language.textAML3.resource.textAML3.ITextAML3QuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.emftext.language.textAML3.resource.textAML3.ITextAML3QuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.emftext.language.textAML3.resource.textAML3.ITextAML3QuickFix> getQuickFixes(org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.emftext.language.textAML3.resource.textAML3.ITextAML3QuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
