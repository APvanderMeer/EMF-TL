...
public class TextAML3LineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.DEBUG_MODEL_ID);
			...
			org.emftext.language.textAML3.resource.textAML3.debug.TextAML3LineBreakpoint lineBreakpoint = new org.emftext.language.textAML3.resource.textAML3.debug.TextAML3LineBreakpoint(resource, lineNumber + 1);
