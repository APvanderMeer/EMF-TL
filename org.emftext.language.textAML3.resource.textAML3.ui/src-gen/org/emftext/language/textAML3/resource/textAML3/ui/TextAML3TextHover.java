 ...
 */
public class TextAML3TextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.textAML3.resource.textAML3.ITextAML3HoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput infoInput = (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Hyperlink hyperlink = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Hyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl iControl = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput) {
							org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput input = (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl iControl = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public TextAML3TextHover(org.emftext.language.textAML3.resource.textAML3.ITextAML3ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TextHover.getStyleSheet());
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.textAML3.resource.textAML3.util.TextAML3StreamUtil.getContent(styleSheetURL.openStream());
