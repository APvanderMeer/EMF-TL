 ...
 * olInput</code>.
 */
public class TextAML3DocBrowserInformationControlInput {
	
	private final TextAML3DocBrowserInformationControlInput fPrevious;
	private TextAML3DocBrowserInformationControlInput fNext;
	 ...
	 */
	public TextAML3DocBrowserInformationControlInput(TextAML3DocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public TextAML3DocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public TextAML3DocBrowserInformationControlInput getNext() {
		return fNext;
	}
