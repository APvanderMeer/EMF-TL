 ...
 * 
 */
package org.emftext.language.textAML3.resource.textAML3.ui.debug;

@SuppressWarnings("restriction")
public class TextAML3AdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getSyntaxName())) {
					return new org.emftext.language.textAML3.resource.textAML3.ui.debug.TextAML3LineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugVariable) {
			final org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugVariable variable = (org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugVariable) {
			final org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugVariable variable = (org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugValue castedValue = (org.emftext.language.textAML3.resource.textAML3.debug.TextAML3DebugValue) value;
