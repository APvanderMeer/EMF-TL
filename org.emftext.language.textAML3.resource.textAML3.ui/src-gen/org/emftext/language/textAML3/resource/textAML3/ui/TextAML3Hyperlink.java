 ...
 */
public class TextAML3Hyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public TextAML3Hyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
