 ...
 */
public class TextAML3NewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public TextAML3NewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new textAML3 file");
