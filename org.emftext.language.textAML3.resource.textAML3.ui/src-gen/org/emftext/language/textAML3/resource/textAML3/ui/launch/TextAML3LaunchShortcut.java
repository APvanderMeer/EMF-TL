 ...
 */
public class TextAML3LaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.textAML3.resource.textAML3.launch.TextAML3LaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Plugin.logError("Exception while launching selection", e);
		}
	}
