 ...
 */
public class TextAML3IgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.language.textAML3.resource.textAML3.grammar.TextAML3GrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
