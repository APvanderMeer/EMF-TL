 ...
 * @since 3.2
 */
public class TextAML3BrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput fInput;
	 ...
	 */
	public TextAML3BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public TextAML3BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public TextAML3BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput) input;
		...
		org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3HTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.textAML3.resource.textAML3.ui.TextAML3DocBrowserInformationControlInput getInput() {
		return fInput;
	}
