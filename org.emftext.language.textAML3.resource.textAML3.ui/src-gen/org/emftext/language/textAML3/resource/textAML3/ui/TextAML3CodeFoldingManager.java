 ...
 */
public class TextAML3CodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.textAML3.resource.textAML3.ITextAML3BackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor) {
				org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor = (org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor) workbenchPart;
	...
	protected org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor;
	 ...
	 */
	public TextAML3CodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource textResource = (org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
