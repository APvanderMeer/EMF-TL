...
/**
 * A text editor for 'textAML3' models.
 * <p>
 * This editor has id
 * <code>org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor</code>
 * The editor's context menu has id
 * <code>org.emftext.language.textAML3.resource.textAML3.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.emftext.language.textAML3.resource.textAML3.EditorRuler</code>.
 * </p>
 */
public class TextAML3Editor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.textAML3.resource.textAML3.ITextAML3ResourceProvider, org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3BracketHandlerProvider, org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3AnnotationModelProvider {
	
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Highlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3CodeFoldingManager codeFoldingManager;
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.textAML3.resource.textAML3.ITextAML3BackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.ITextAML3BackgroundParsingListener>();
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3ColorManager colorManager = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3ColorManager();
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3OutlinePage outlinePage;
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PropertySheetPage propertySheetPage;
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3BracketHandler bracketHandler;
	...
	public TextAML3Editor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3SourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), TextAML3Editor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource currentResource = getResource();
				...
				org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.textAML3.resource.textAML3.EditorContext");
		setRulerContextMenuId("org.emftext.language.textAML3.resource.textAML3.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Highlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3CodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Nature.activate(inputFile.getProject());
		...
		org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource loadedResource = (org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) {
					setResource((org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the TextAML3Editor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3OutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource textResource = (org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) element.eResource();
			org.emftext.language.textAML3.resource.textAML3.ITextAML3LocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.textAML3.resource.textAML3.ITextAML3TextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.textAML3.resource.textAML3.ITextAML3TextToken token = lexer.getNextToken();
			...
			org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!TextAML3Editor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.textAML3.resource.textAML3.ITextAML3BackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.textAML3.resource.textAML3.ITextAML3BackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3BracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3BracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource)) {
					return false;
				}
				org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource textResource = (org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) resource;
				org.emftext.language.textAML3.resource.textAML3.ITextAML3LocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
