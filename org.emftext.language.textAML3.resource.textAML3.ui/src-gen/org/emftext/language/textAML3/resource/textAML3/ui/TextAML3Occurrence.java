 ...
 */
public class TextAML3Occurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.textAML3.resource.textAML3.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.textAML3.resource.textAML3.ui.occurences.declaration";
	...
	private org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TokenScanner tokenScanner;
	...
	private org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource textResource;
	 ...
	 */
	public TextAML3Occurrence(org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3TokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3BracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Occurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Occurrence.DECLARATION_ANNOTATION_ID);
	}
