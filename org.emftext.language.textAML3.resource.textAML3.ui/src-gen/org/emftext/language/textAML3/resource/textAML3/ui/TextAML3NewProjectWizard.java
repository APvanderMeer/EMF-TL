 ...
 */
public class TextAML3NewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public TextAML3NewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.textAML3.resource.textAML3.ui");
							...
							String natureID = org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Nature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3Nature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation info = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.textAML3.resource.textAML3.ui.TextAML3UIPlugin.getDefault().getBundle();
