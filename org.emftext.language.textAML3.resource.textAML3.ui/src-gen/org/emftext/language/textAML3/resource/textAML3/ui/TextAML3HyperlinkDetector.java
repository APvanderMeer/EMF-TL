 ...
 * hovers, is a proxy.
 */
public class TextAML3HyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public TextAML3HyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.emftext.language.textAML3.resource.textAML3.ITextAML3TextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Hyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
