 ...
 */
public class TextAML3BracketSet {
	...
	private java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.textAML3.resource.textAML3.ui.ITextAML3BracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public TextAML3BracketSet(org.emftext.language.textAML3.resource.textAML3.ui.TextAML3Editor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.textAML3.resource.textAML3.mopp.TextAML3MetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair>();
	 ...
	 */
	public org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair remove(String opening, String closing) {
		for (org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.textAML3.resource.textAML3.ITextAML3BracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.textAML3.resource.textAML3.ui.TextAML3PositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
