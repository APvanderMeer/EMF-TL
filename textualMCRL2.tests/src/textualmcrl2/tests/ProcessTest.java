 ...
 * @generated
 */
public class ProcessTest extends NameableTest {
	 ...
	 */
	@Override
	protected textualmcrl2.Process getFixture() {
		return (textualmcrl2.Process)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(Textualmcrl2Factory.eINSTANCE.createProcess());
	}
